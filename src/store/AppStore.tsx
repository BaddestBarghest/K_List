...
import type { AppState, Kink, ListDef } from "../types";
...
type Action =
  | { type: "ADD_CUSTOM_KINK"; name: string; description?: string }
  | { type: "UPDATE_KINK"; id: string; patch: Partial<Pick<Kink, "name" | "description">> }
